...
export default function Home() {
  ...
  <body>
      <div class="container">
          ...
          }" alt="Banner of AWS Educate">
          <p>親愛的{name} ，</p>
          <div>
              <p>您好！</p>
              <p>恭喜您成功加入<strong class="highlight">「${title}」</strong>！非常高興您決定與我們一起踏上學習的旅程，共同探索雲端技術的無限可能！</p>
          ...
          <div>
              ...
              <p>有意願參加活動請填寫以下報名表單，<span class="important">表單將於 ${deadline} 截止</span>：<a target="_blank" href="${eventLink}">點擊這裡</a></p>
