        ...
        <div>
          ...
          <div className="flex w-full gap-4 text-xl">
            <a
              href="/path-to-pdf"
              target="_blank"
              className="flex gap-2 p-4 w-1/2 items-center bg-gray-200 text-gray-800 rounded-lg shadow-md hover:bg-gray-300 transition duration-300"
            >
            ...
            <a
              ...
              target="_blank"
              className="flex gap-2 p-4 w-1/2 items-center bg-sky-950 text-white rounded-lg shadow-md hover:bg-sky-800 transition duration-300"
            >
