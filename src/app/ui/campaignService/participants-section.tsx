...
export default function ParticipantsSection({
  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-4 sm:p-6">
      <h3 className="text-lg sm:text-xl font-bold mb-2">Participants Attendance</h3>
      ...
      <div className="mb-4">
        ...
        <Listbox value={selectedRunId} onChange={onRunChange}>
          <div className="relative">
            <Listbox.Button className="relative w-full cursor-default rounded-xl bg-white py-3 pl-4 pr-10 text-left shadow-sm border border-gray-300 focus:border-gray-600 focus:outline-none focus:ring-2 focus:ring-gray-600 text-sm sm:text-base">
