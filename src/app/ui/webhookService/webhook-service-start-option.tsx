...
interface WebhookServiceStartOptionProps {
  onSelect: (mode: "new" | "edit-existing" | "modify") => void;
}

export default function WebhookServiceStartOption({ onSelect }: WebhookServiceStartOptionProps) {
  return (
        ...
        <div className="mt-6 space-y-8">
          ...
          <div className="text-center space-y-4">
            ...
            <p className="text-base md:text-lg text-gray-600 max-w-xl mx-auto">
              Choose your preferred way to get started with webhooks
            </p>
          </div>
          ...
          <div className="relative md:space-y-0 space-y-6">
            ...
            <div className="flex justify-center">
              <button onClick={() => onSelect("new")} className="group relative w-full max-w-md">
                <div className="aspect-square bg-slate-800 hover:bg-slate-700 rounded-full flex items-center justify-center transform transition-all duration-500 hover:scale-105 shadow-lg shadow-blue-200/50">
            ...
            <div className="flex flex-col md:flex-row justify-center items-center md:gap-64 gap-6">
              ...
              {/* Modify */}
              <button onClick={() => onSelect("modify")} className="group w-48">
                <div className="aspect-square rounded-full bg-gray-100 hover:bg-gray-200 flex flex-col items-center justify-center transition-all duration-300 hover:scale-105 shadow-md shadow-gray-400/50">
                  <div className="text-center space-y-2 px-2">
                    <div className="text-3xl md:text-4xl">🔁</div>
