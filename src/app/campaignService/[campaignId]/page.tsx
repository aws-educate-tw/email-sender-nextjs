...
export default function CampaignDetailPage() {
  ...
  return (
    <div className="space-y-6 px-4 sm:px-0">
      ...
      <button className="w-full bg-gray-100 rounded-lg shadow-md p-4 sm:p-6 text-base sm:text-lg font-bold text-gray-700 hover:text-gray-900 hover:bg-gray-200 transition-colors cursor-pointer text-left">
