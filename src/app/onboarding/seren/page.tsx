...
export default function Page() {
  ...
  const handleStartQuiz = async () => {
    ...
    try {
      ...
      const response = await fetch(`${base_url}/onboarding/seren`, { cache: "no-store" });
      ...
      setApiError("Failed to load introduction data");
      setOnboardingData({
        name: "Seren",
        ...
        <div className="w-full max-w-2xl rounded-3xl bg-white p-12 shadow-2xl">
          ...
          <div className="flex justify-center">
            <button
              ...
              disabled={isLoading}
              className="rounded-full bg-gradient-to-r from-[#A5B8C6] to-[#6E7B8E] px-12 py-4 text-lg font-semibold text-white shadow-lg transition-all hover:scale-105 hover:shadow-xl disabled:opacity-50"
            >
  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-gradient-to-br from-[#E8E3D4] to-[#A5B8C6] px-4 py-12">
      <div className="w-full max-w-3xl rounded-3xl bg-white p-8 shadow-2xl md:p-12">
        ...
        {apiError && (
          <div className="mb-4 rounded-2xl border-l-4 border-red-400 bg-red-50 p-4">
        ...
        {onboardingData && (
          <div className="mb-8 rounded-2xl border-l-4 border-[#6E7B8E] bg-[#E8E3D4] p-6">
            <p className="text-center text-lg italic text-[#6E7B8E]">
              &ldquo;{onboardingData.introduction}&rdquo;
            </p>
          </div>
        )}
